...
This repository contains the source code of several algorithms for **generation of separating codes**, written by 
 Francisco-José Martínez-Zaldívar<sup>1</sup>, Víctor M. García-Mollá<sup>2</sup>, 
Marcel Fernández<sup>3</sup>, M.ª Ángeles Simarro<sup>4</sup>,
John Livieratos<sup>5</sup> and Alberto González<sup>1</sup>.
...
<h6><sup>1</sup> Department of Communications. Universitat Politècnica de València, València (Spain)</span><br>
    <sup>2</sup> Department of Informatics Systems and Computation. Universitat Politècnica de València, València (Spain)<br>
    <sup>3</sup> Department of Network Engineering, Universitat Politècnica de Catalunya, Barcelona (Spain)</span><br>
    <sup>4</sup> ITEAM, Institute of Telecommunications and Multimedia Applications, Universitat Politècnica de València, València (Spain)</span><br>
    <sup>5</sup> Department of Mathematics. National Kapodistrian University of Athens, (Greece)</h6>
...
CIPROM/2022/20. The work of Marcel Fernández has been supported by TCO-RISEBLOCK
(PID2019-110224RB-I00) MINECO.
